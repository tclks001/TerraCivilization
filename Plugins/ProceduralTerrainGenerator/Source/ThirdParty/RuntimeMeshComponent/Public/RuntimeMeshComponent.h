...
private:
	...
	UPtgRuntimeMesh* RuntimeMeshReference;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Components|RuntimeMeshComponent")
	void SetRuntimeMesh(UPtgRuntimeMesh* NewMesh);

	/** Clears the geometry for ALL collision only sections */
	UFUNCTION(BlueprintCallable, Category = "Components|RuntimeMeshComponent")
	FORCEINLINE UPtgRuntimeMesh* GetRuntimeMesh() const
	{
	...
	/** Clears the geometry for ALL collision only sections */
	UFUNCTION(BlueprintCallable, Category = "Components|RuntimeMeshComponent")
	FORCEINLINE UPtgRuntimeMesh* GetOrCreateRuntimeMesh()
	{
...
private:
	...
	/** Called by UPtgRuntimeMesh any time it has new collision data that we should use */
