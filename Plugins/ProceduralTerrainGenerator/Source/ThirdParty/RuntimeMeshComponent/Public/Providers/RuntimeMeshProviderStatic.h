...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Providers|Static")
	void ClearAllLODsForSection(const int32 sectionID)
	{
		const int32 numerOfConfiguredLODs = LODConfigurations.Num();
		for (int32 LODIndex = 0; LODIndex < numerOfConfiguredLODs; LODIndex++)
		{
