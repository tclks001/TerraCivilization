...
public:
	...
	{
		Data.SetNum(NewNum, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
	}
...
public:
	...
	{
		Data.SetNum(NewNumChannels, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
	}

	void SetNumCoords(int32 ChannelId, int32 NewNumCoords, bool bAllowShrinking)
	{
		Data[ChannelId].SetNum(NewNumCoords, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
	}
	...
	void SetNum(int32 NewNumChannels, int32 NewNumCoords, bool bAllowShrinking = true)
	{
		...
		{
			Data[Index].SetNum(NewNumCoords, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
		}
	}
	...
	{
		Data.SetNum(NumChannels, EAllowShrinking::No);
		for (int32 Index = 0; Index < Data.Num(); Index++)
		{
...
public:
	...
	{
		Data.SetNumZeroed(NewNum, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
	}
