...
struct FRuntimeMeshSectionProxyBuffers : public TSharedFromThis<FRuntimeMeshSectionProxyBuffers>
{
	...
	void InitFromRHIReferences(FRuntimeMeshSectionUpdateData& UpdateData, FRHIResourceReplaceBatcher& Batcher)
	{
	...
	//template <uint32 MaxNumUpdates>
	void ApplyRHIReferences(FRuntimeMeshSectionUpdateData& UpdateData, FRHIResourceReplaceBatcher& Batcher)
	{
