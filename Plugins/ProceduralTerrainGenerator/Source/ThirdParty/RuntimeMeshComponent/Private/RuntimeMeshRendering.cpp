...
void FRuntimeMeshVertexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
}
...
void FRuntimeMeshIndexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
}
...
void FRuntimeMeshVertexFactory::Init(FLocalVertexFactory::FDataType VertexStructure)
{
	...
	{
		SetData(GetImmediateCommandList(), VertexStructure);
	}
	else
	{
